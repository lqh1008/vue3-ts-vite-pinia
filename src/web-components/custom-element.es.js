      ...
      return (
        ...
        createElementBlock(
          'button',
          {
            onClick:
              _cache[0] ||
              (_cache[0] = ($event) => (isDark.value = !isDark.value))
          },
          [
            isDark.value
              ? (openBlock(),
                createElementBlock('span', _hoisted_1, '\u{1F319}'))
              : (openBlock(),
                createElementBlock('span', _hoisted_2, '\u{1F31E}')),
            renderSlot(_ctx.$slots, 'default', {}, () => [_hoisted_3])
          ]
        )
      )
    }
...
var VueDarkModeSwitch = /* @__PURE__ */ _export_sfc(_sfc_main, [
  ['styles', [_style_0]]
])
